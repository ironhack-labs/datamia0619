...
<<<<<<< HEAD
    - Next, we will need to drag and drop the Opponent field into the Details box of the Marks section. Change the type of the data in this from Measure to Dimensions. This will expand the box and whiskers in the visualization, allowing us to see how the averages vary based on the opposing team instead of just the overall average.
=======
...
>>>>>>> ae0a01841162cfee91fba5868acfb8b6b99d2a89
